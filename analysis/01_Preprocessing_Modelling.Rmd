...
AV_TESTCORT = c(TESTCORTlogBL = 0, TESTCORTlog10=10, TESTCORTlog55 = 55),
...
We adapted a boxed design by individual over Time with a 2 polynomial decomposion

```{r modeldef_poly}
models=list(
AV_stressed = "DV~1+age_meancentered+explstart_meancentered_min+BMI_imp_meancentered+any_med_ccept+smoking_yes_no+gender+group+poly(Time, 7)+gender*group+poly(Time, 2)*group+(1|twuid)+(1|centre)",

AV_CORT = "DV~1+age_meancentered+explstart_meancentered_min+BMI_imp_meancentered+any_med_ccept+smoking_yes_no+gender+group+poly(Time, 4)+gender*group+poly(Time, 2)*group+(1|twuid) + (1|centre)",

AV_TEST = "DV~1+age_meancentered+explstart_meancentered_min+BMI_imp_meancentered+any_med_ccept+smoking_yes_no+gender+group+poly(Time, 2)+gender*group+poly(Time, 2)*group+(1|twuid) + (1|centre)",

AV_TESTCORT = "DV~1+age_meancentered+explstart_meancentered_min+BMI_imp_meancentered+any_med_ccept+smoking_yes_no+gender+group+poly(Time, 2)+gender*group+poly(Time, 2)*group+(1|twuid) + (1|centre)",

AV_OXT = "DV~1+age_meancentered+explstart_meancentered_min+BMI_imp_meancentered+any_med_ccept+smoking_yes_no+gender+group+poly(Time, 2)+gender*group+poly(Time, 2)*group+(1|twuid) + (1|centre)")
```
